...
var sassNeatPaths = require('node-neat').with([
  path.resolve(__dirname, './app/assets/styles')]).map(function (neatPath) {
...
module.exports = {
  ...
  module: {
    ...
    loaders: [
      ...
      {
        test: /\.scss$/,
        loader: ExtractTextPlugin.extract('style', 'css?sourceMap!sass?sourceMap&' + sassNeatPaths, 'autoprefixer')
      },
      {
        test: /\.(sass|scss)$/,
        use: [
